...
A fully-featured, production-grade real-time document collaboration platform inspired by Google Docs — built with **Next.js 14**, **TypeScript**, **Pusher**, and **Cloud-native architecture**.  
